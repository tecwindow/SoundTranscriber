Руководство пользователя Sound Transcriber версия {}
...
- Преобразование видео с таких платформ, как YouTube, Facebook и X с загрузкой файла напрямую, с возможностью сохранения файла для удобного доступа и использования в будущем.
...
- В настоящее время Sound Transcriber поддерживает следующие языки: английский, арабский, вьетнамский, испанский, французский, русский и турецкий.
...
- Пожертвовать: пожертвуйте разработчикам Sound Transcriber.
- Открыть репозиторий: Открывает репозиторий Sound Transcriber на GitHub, программа не имеет открытого исходного кода.
...
Хотя перевод истории изменений и руководства пользователя не является обязательным, вы можете перевести их на свой язык с помощью pot-файлов.

Мы используем .md-файлы для создания .pot-файлов, которые затем отправляем переводчикам. После этого мы конвертируем .po-файлы, полученные от переводчиков, обратно в .md-файлы, а затем в .html-файлы для включения в программу.

Это позволяет нам вносить исправления в любую часть руководства и систории изменений, гарантируя их единообразное применение на всех поддерживаемых языках. Это также гарантирует, что файлы на разных языках будут иметь одинаковый формат и структуру.

Чтобы перевести файлы, выполните следующие действия:

- Получите файлы .pot из репозитория на GitHub или из папки документации в каталоге Sound Transcriber.
- Переведите их с помощью Poedit.
- Некоторые фразы могут повторяться с дополнительными точками. Мы используем это для того, чтобы различать фразы и следить за тем, чтобы они стояли в правильном порядке. Добавьте столько же точек, и мы уберём их при добавлении перевода в программу.
- Обратите внимание, что тексты могут располагаться в неправильном порядке, если перевод неполный. После правильного перевода снова откройте файл, чтобы просмотреть их в правильном порядке.
...
-   Большое спасибо   Kadir öz   за перевод   Sound Transcriber   на турецкий язык.
- Большое спасибо Нгуен Ань Дыку за перевод Sound Transcriber на вьетнамский язык.
